...
<?php require_once(APPPATH . 'views/cebudirectories/header.php'); ?>    
    ...
    <div id="cd-content">
    	<h1>Cebu Directories Services</h1>
        
        <div class="left center services_block">
        	<h3>Business Listing</h3>
            <div class="services_listing"><a href="">
            	<img class="icenter" src="<?php echo url::base(); ?>images/services/business-directory-listing-off.jpg" />
            </a></div>
        ...
        <div class="left center services_block">
            ...
            <div class="services_webdev"><a href="">
            	<img class="icenter" src="<?php echo url::base(); ?>images/services/web-development-off.jpg" />
            </a></div>
