...
<?php require_once(APPPATH . 'views/cebudirectories/header.php'); ?>   
    ...
    <div id="cd-content">
        ...
        <li class="left" style="width:320px;">
            <h3>Google</h3>
            <p style="height: 160px; ">
            <a href="<?php echo url::base(); ?>images/services/cebudirectories-seo-google.png" title="Google SEO Rank 1" class="thickbox" rel="seo"> </a>
            <a href="<?php echo url::base(); ?>images/services/cebudirectories-seo-google2.png" title="Google SEO Rank 1" class="thickbox" rel="seo"><img src="<?php echo url::base(); ?>images/services/cebudirectories-seo-google2-thumb.png" alt="Google SEO Rank 1" /></a>
            </p>
        </li>
        <li class="left" style="width:320px;">
            <h3>Yahoo</h3>
            <p style="height: 160px; ">
            <a href="<?php echo url::base(); ?>images/services/cebudirectories-seo-yahoo.png" title="Yahoo SEO Rank 1" class="thickbox" rel="seo"><img src="<?php echo url::base(); ?>images/services/cebudirectories-seo-yahoo-thumb.png" alt="Yahoo SEO Rank 1" /></a>
            <a href="<?php echo url::base(); ?>images/services/cebudirectories-seo-yahoo2.png" title="Yahoo SEO Rank 1" class="thickbox" rel="seo"> </a>
            </p>
        </li>
        <li class="left" style="width:320px;">
            <h3>Bing</h3>
            <p style="height: 160px; ">
            <a href="<?php echo url::base(); ?>images/services/cebudirectories-seo-bing.png" title="Bing SEO Rank 1" class="thickbox" rel="seo"><img src="<?php echo url::base(); ?>images/services/cebudirectories-seo-bing-thumb.png" alt="Bing SEO Rank 1" /></a>
            <a href="<?php echo url::base(); ?>images/services/cebudirectories-seo-bing2.png" title="Bing SEO Rank 1" class="thickbox" rel="seo"> </a>        
            </p>
        </li>
        </ul>
        <div class="clear"></div>
        ...
        <tbody>
        <tr>
            <td>Basic Listing<br /><a href="<?php echo url::base(); ?>images/advertising/ads-prime.jpg" class="thickbox" >view</a></td>
            <td>
            <ul>
                <li>Business Name</li>
                <li>Address</li>
        ...
        <tr>
            <td>Premium Listing<br /><a href="<?php echo url::base(); ?>images/advertising/ads-text.png" class="thickbox" >view</a></td>
            <td>
            <ul>
                <li>Business Name</li>
                <li>Logo</li>
