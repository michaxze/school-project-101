...
<?php require_once('header.php'); ?>    
    ...
    <div id="cd-content">
        ...
        telephone number, mobile number and email address when you register to 
        Cebu Directories.  As well as business or what we labeled as listing informations 
        such as name, address, telephone number, fax number, mobile number, website, and 
        email. Names, email addresses and websites collected under the listings comments 
        are treated as well.
    	</p>
		...
		information by sending a notice to the primary email address.  Id you have questions or 
		suggestions, please complete a feedback form or you can contact us at info@cebudirectories.com
    	</p>
    </div>
