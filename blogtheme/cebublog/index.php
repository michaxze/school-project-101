	...
	<div id="content">
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
                ...
                <h1><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>" class="posts-title"><?php the_title(); ?></a></h1>
				...
				<div class="posts-content">
					<?php the_content('<span class="more">Read the rest of this entry &raquo;</span>'); ?>
				</div>
